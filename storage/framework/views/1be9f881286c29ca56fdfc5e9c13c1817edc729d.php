              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                      ...
                      <input class="form-control" id="no_of_hostel" name="no_of_hostel" type="text" aria-describedby="" placeholder="Enter No. Of Hostel">
                    </div>  
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/i1kpir9wdpln/public_html/meraroom/resources/views/admin/plan/plan-create.blade.php ENDPATH**/ ?>