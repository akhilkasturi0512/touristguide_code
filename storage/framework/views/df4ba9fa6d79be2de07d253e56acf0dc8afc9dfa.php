                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card-footer">
                                                    <button id="submitButton" type="submit" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Saving..." data-rest-text="Save" class="btn btn-primary">Update</button>
                                                      ...
                                                      <a  href= "<?php echo e(route('service_property-list')); ?>" class="btn btn-secondary">Cancel</a>
                                                    <center>
                                                    ...
                                                    <div class="modal-content">
                                                      ...
                                                      <div class="modal-body">
                                                       ...
                                                       <div class="modal-footer">
                                                        <button class="btn btn-secondary" type="button" data-bs-dismiss="modal" data-bs-original-title="" title="">Update</button>
                                                          <a  href= "<?php echo e(route('service_property-list')); ?>" class="btn btn-secondary">Cancel</a>
                                                      </div>
                                                    </div>
                                                </div>
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    if (data.status) {
                                        ...
                                        $('#submitForm')[0].reset();
                                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('service_property-list')); ?>";
                            }, 3000);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/androidhiker/public_html/travelguide/resources/views/admin/service/service_property-edit.blade.php ENDPATH**/ ?>