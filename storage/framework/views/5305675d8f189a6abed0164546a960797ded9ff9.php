    ...
    <div class="container-fluid">
        <div class="row">
					...
					<div class="card-body">
						<div class="text-center">
							<div class="userprofile">
								<div class="userpic  brround"> <img src="<?php echo e(asset(''.auth()->user()->profile_image)); ?>" height="50px" width="60px" alt="" class="userpicimg"> </div>
			...
			<div class="card" >
					...
					<form id="submitForm"  method="post" action="<?php echo e(route('password-update')); ?>" style="display:none">
			...
			<div class="card" >
					...
					<form id="submitForm1" enctype="multipart/form-data"  method="post" action="<?php echo e(route('email-update')); ?>" style="display:none">
                    <?php echo e(csrf_field()); ?>
        ...
        $(function () { 
           $('#submitForm1').submit(function(){
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
                        window.location = "<?php echo e(route('admin.logout')); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/androidhiker/public_html/travelguide/resources/views/admin/setting/setting.blade.php ENDPATH**/ ?>