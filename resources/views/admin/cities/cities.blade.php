              ...
              <div class="card-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-12">
                      <ul class="d-flex" >
                        <li ><a class="@if($type=='') text-primary @else text-dark @endif " style="text-decoration: underline;" href="{{route('cities-list')}}">Active ({{ $data['active'] }})</a> </li>&nbsp; | &nbsp;
                        <li ><a class="@if($type=='Inactive') text-primary @else text-dark @endif"  style="text-decoration: underline;" href="{{route('cities-list','Inactive')}}">Inactive ( {{ $data['inactive'] }})</a></li>
