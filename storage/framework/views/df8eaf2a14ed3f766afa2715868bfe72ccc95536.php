            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('banner_type-list')); ?>";
                            }, 3000);
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/androidhiker/public_html/travelguide/resources/views/admin/banner_type/banner_type-edit.blade.php ENDPATH**/ ?>