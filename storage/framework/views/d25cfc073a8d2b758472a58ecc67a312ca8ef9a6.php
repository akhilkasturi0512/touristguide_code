                          ...
                          <div class="col-md-11" style=" padding: 15px;">
                            <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="title0" name="title[]" type="text" aria-describedby="" placeholder="Enter Title">
                                  </div>

                                  <div class="col-md-6">
                                    <label class="col-form-label pt-0" for="description0">Description</label>
                                    <input class="form-control" id="description0" name="description[]" type="text" aria-describedby="" placeholder="Enter Description">
                                  </div>
                            </div>
                          </div>
...
<script type="text/javascript">
    ...
    $("#price").on('keyup',function(){
       ...
       percentValue = price*percent/100;
       console.log(percentValue);
       $("#rent").val( parseFloat(percentValue) );
        ...
        function addMoreData(){
          ...
          <div class="row copiesrow${counter}">
              <div class="col-md-11" style=" padding: 15px;">
                ...
                <div class="col-md-6">
                <label class="col-form-label pt-0" for="title${counter}">Title</label>
                <input class="form-control" id="title${counter}" name="title[]" type="text" aria-describedby="" placeholder="Enter Title">
                </div>

                <div class="col-md-6">
                <label class="col-form-label pt-0" for="description${counter}">Description</label>
                <input class="form-control" id="description${counter}" name="description[]" type="text" aria-describedby="" placeholder="Enter Description">
                </div>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/i1kpir9wdpln/public_html/meraroom/resources/views/admin/faq/faq-create.blade.php ENDPATH**/ ?>