                ...
                <form id="submitForm"  class="forms-sample" action="<?php echo e(route('coupon-store')); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                            <label for="cart_value">Coupon Uses</label>
                            <input type="text" class="form-control" id="coupon_uses" name="coupon_uses" placeholder="Coupon Uses">
                          </div>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\merarooms\resources\views/admin/coupon/coupon-create.blade.php ENDPATH**/ ?>