         ...
         <div class=" col-md-12 col-lg-12 col-xl-12">
            <div class="row">
                ...
                <div style="display:flex;align-items:center;justify-content: space-evenly;">
                     ...
                     <div class="col-sm-12 col-lg-4 col-md-4 ">
                  <div class="card">
                     <a href="<?php echo e(route('hostelOwner-list',1)); ?>"><div class="card-body"style="border: 2px solid black; border-radius: 2%;" >
                <div style="display:flex;align-items:center;justify-content: space-evenly;">
                            <div style="display:flex;align-items:right">
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/i1kpir9wdpln/public_html/meraroom/resources/views/admin/welcome.blade.php ENDPATH**/ ?>