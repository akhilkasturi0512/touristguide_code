                      ...
                      <div class="row">
                        <div class="col-sm-6">
                         ...
                         <div class="col-sm-6" style="justify-content: end; display: flex;">
                           <a href="<?php echo e(route('service_property-create')); ?>" class="btn btn-primary">Add Property</a>
                        </div>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/androidhiker/public_html/tourist_guide/resources/views/admin/service/service_property.blade.php ENDPATH**/ ?>