            ...
            <div class="col-sm-12">
              ...
              <div class="card">
                ...
                <div class="card-footer">
                  ...
                  <button id="submitButton"  type="submit" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Saving..." data-rest-text="Save" class="btn btn-primary"> <i class="fa fa-save"></i> Update</button>
                     <a  href= "<?php echo e(route('role-list')); ?>" class="btn btn-secondary">Cancel</a>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/androidhiker/public_html/tourist_guide/resources/views/admin/role/role-edit.blade.php ENDPATH**/ ?>