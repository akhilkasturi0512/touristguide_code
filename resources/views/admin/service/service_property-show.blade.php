                  ...
                  <div class="tab-content" id="info-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="info-home" role="tabpanel" aria-labelledby="info-home-tab">
                      ...
                      <div class="table-responsive">
                        <table class="table table-hover">
                          <thead>
                            ...
                            <tr>
                              ...
                              <td scope="col"  width="500">{{$service_property->business_name}}</td>

                              <th scope="col" width="200">Hostel Owner : </th>
                              <td scope="col"  width="500">{{$service_property->hostelowner ? $service_property->hostelowner->name : 'N/A'}}</td>

                            </tr>

                            <tr>
                                <th scope="col" width="200">Business Category : </th>
                                <td scope="col"  width="500">{{$service_property->businesscat ? $service_property->businesscat->name : 'N/A'}}</td>

                                <th scope="col" width="200">Price :</th>
                                <td scope="col"  width="500"><i class="fa fa-inr"></i> {{$service_property->price}}</td>
                            </tr>

                            <tr>
                              <th scope="col" width="200">State :</th>
                              <td scope="col"  width="500"> {{$service_property->state_name}}</td>

                              <th scope="col" width="500">City :</th>
                              <td scope="col"  width="500"> {{$service_property->city_name}}</td>
                            </tr>
                            
                             <tr>
                              <th scope="col" width="200">Address :</th>
                              <td scope="col"  width="500"> {{$service_property->address}}</td>

                              <th scope="col" width="500">Description :</th>
                              <td scope="col"  width="500"> {!!$service_property->description!!}</td>
                            </tr>
                        ...
                        <div class="row">
                             @foreach ($service_property->property_images as $key => $item)
                                <div class=" col-md-3">
                                  <div class="box box1">
