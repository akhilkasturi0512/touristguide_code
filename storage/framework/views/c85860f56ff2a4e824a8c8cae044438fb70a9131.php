            ...
            <div class="col-sm-12">
              ...
              <div class="card">
                ...
                <div class="card-footer">
                  ...
                  <a  href= "<?php echo e(route('cities-list')); ?>" class="btn btn-secondary">Cancel</a>
                </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('cities-list')); ?>";
                            }, 3000);
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/androidhiker/public_html/travelguide/resources/views/admin/cities/cities-edit.blade.php ENDPATH**/ ?>