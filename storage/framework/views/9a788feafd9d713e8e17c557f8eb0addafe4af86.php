              ...
              <div class="card">
                ...
                <div class="card-body">
                     ...
                     <div class="mb-3">
                        ...
                        <select class="form-select" id="type"
                            ...
                            <?php $__currentLoopData = $banner_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($post->type == $item->name): ?> selected <?php endif; ?> value="<?php echo e($item->name); ?>">
                    ...
                    <div class="mb-3">
                      ...
                      <input class="form-control" id="title" name="title" type="text" aria-describedby="" value="<?php echo e($post->title); ?>" placeholder="Enter title">
                    </div>


                    <div class="mb-3 ">
                        <label class="col-form-label pt-0" for="banner">Image</label>
                        <input class="form-control" id="banner"  value="<?php echo e($post->image); ?>" name="banner" type="file" placeholder="banner">
                    </div>


                    <div class="mb-3">
                        <?php if($post->image): ?>
                            <img width="200" src="<?php echo e(asset($post->image)); ?>" alt="" srcset="">
                        <?php endif; ?>
                    </div>
                ...
                <div class="card-footer">
                 ...
                 <a  href= "<?php echo e(route('vendorbanner-list')); ?>" class="btn btn-secondary">Cancel</a>
                </div>
              </div>
            </form>
            </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('vendorbanner-list')); ?>";
                            }, 3000);
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/androidhiker/public_html/travelguide/resources/views/admin/vendor_banner/banner-edit.blade.php ENDPATH**/ ?>