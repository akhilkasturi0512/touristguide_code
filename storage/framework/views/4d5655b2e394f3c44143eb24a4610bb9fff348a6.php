            ...
            <div class="col-sm-12">
                <div class="card-body">
                    <ul class="nav nav-tabs border-tab nav-primary" id="info-tab" role="tablist">
                      ...
                      <li class="nav-item"><a class="nav-link" id="mess-info-tab"data-bs-toggle="tab" href="#buy-subscription" role="tab" aria-controls="buy-subscription"aria-selected="false"><i class="icofont icofont-lunch"></i>Subscription Details </a></li>
                    </ul>
                    <div class="tab-content" id="info-tabContent">
                        ...
                        <form  enctype="multipart/form-data" method="POST" class="theme-form" id="submitForm" action="<?php echo e($data['url']); ?>">
                            ...
                            <div class="card-body">
                                ...
                                <!--</div>-->
                                   ...
                                   <div class="mb-3">
                                    ...
                                    <div class="mb-3 col-md-12">
                                      ...
                                      <input class="form-control" id="address" name="address" value="<?php echo e($post->address); ?>" type="text" aria-describedby="" placeholder="Enter address">
                                    </div>
                                ...
                                <div class="mb-3">
                                  ...
                                  <input class="form-control" id="commision" value="<?php echo e($post->commision); ?>" name="commision" type="text" aria-describedby="" placeholder="Enter Commision">
                                </div>
                            ...
                            <div class="card-footer">
                              <button   type="submit" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Saving..." data-rest-text="Save" class="btn btn-primary">Update</button>
                               <a href="<?php echo e(route('hostelOwner-list',1)); ?>" class="btn btn-secondary">Cancel</a>
                            </div>
                          </div>
                      ...
                      <div class="tab-pane fade" id="info-bank" role="tabpanel" aria-labelledby="bank-info-tab">
                       ...
                       <div class="tab-pane fade" id="buy-subscription" role="tabpanel" aria-labelledby="mess-info-tab">
                                    ...
                                    <form enctype="multipart/form-data" class="theme-form d-flex" id="subscriptionUpdateForm" method="POST" action="<?php echo e(route('vendor_subscription-update', $post->id)); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="col-sm-12 col-xl-12">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-footer">
                                                            ...
                                                            <button type="submit" id="submitButton" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Saving..." data-rest-text="Save" class="btn btn-primary">Update</button>
                                                             <a href="<?php echo e(route('hostelOwner-list',1)); ?>" class="btn btn-secondary">Cancel</a>
                                                        </div>
            ...
            $('#submitForm').submit(function(){
                ...
                success: function(data) {
                    if(data.status){
                        ...
                        $('#submitForm')[0].reset();
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('hostelOwner-list',1)); ?>";
                            }, 3000);
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/merarum/public_html/app/resources/views/admin/hostelowner/hostelowner-edit.blade.php ENDPATH**/ ?>