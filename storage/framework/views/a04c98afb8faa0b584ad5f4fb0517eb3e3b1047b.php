              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="default_icon"  value="<?php echo e($post->default_icon); ?>" name="default_icon" type="file" placeholder="Icon">
                    </div>
                    
                    <div class="mb-3">
                       
                        <?php if($post->default_icon): ?>
                            <img width="200" src="<?php echo e(asset($post->default_icon)); ?>" alt="" srcset="">
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if($post->icon): ?>
                            <img width="200" src="<?php echo e(asset($post->icon)); ?>" alt="" srcset="">
                        <?php endif; ?>
                    </div>
                ...
                <div class="card-footer">
                  ...
                  <a href="<?php echo e(route('room_type-list')); ?>" class="btn btn-secondary">Cancel</a>
                </div>
              </div>
            </form>
            </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('room_type-list')); ?>";
                            }, 3000);
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/merarum/public_html/app/resources/views/admin/room_type/room_type-edit.blade.php ENDPATH**/ ?>