                        ...
                        $('#submitForm').submit(function() {
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    if (data.status) {
                                        var btn =
                                        '<a href="<?php echo e(route('service_property-list')); ?>" class="btn btn-info btn-sm">GoTo List</a>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/androidhiker/public_html/tourist_guide/resources/views/admin/service/service_property-edit.blade.php ENDPATH**/ ?>