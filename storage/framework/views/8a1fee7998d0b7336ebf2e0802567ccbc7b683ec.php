              ...
              <div class="card">
                ...
                <div class="card-footer">
                  <button  id="submitButton"   type="submit" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Saving..." data-rest-text="Save" class="btn btn-primary">Save</button>
                    <a  href= "<?php echo e(route('faq-list')); ?>" class="btn btn-secondary">Cancel</a>
                </div>
              </div>
            </form>
            </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('faq-list')); ?>";
                            }, 3000);
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/androidhiker/public_html/travelguide/resources/views/admin/faq/faq-edit.blade.php ENDPATH**/ ?>