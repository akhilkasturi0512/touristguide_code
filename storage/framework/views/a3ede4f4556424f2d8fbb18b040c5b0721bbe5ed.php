    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'service_property.business_name', name: 'service_property.business_name'},
		...
		var table = $('.data-table').DataTable();
			...
			$(document).on('click','.deleteButton', function(){
                ...
                var con = confirm("Are You Sure Want to Delete This Rating");
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/i1kpir9wdpln/public_html/meraroom/resources/views/admin/banner/rating.blade.php ENDPATH**/ ?>