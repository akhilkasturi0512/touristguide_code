              ...
              <div class="col-sm-12">
                ...
                <div class="card">
                      ...
                      <div class="mb-3 ">
                       ...
                       <div class="mb-3">
                        ...
                        <div class="form-group col-6">
                            ...
                            <select name="state_id"  id="state_id"    onchange="getCities('state_id','city_id')"  class=" form-control state_id states">
                        ...
                        <div class="form-group col-6">
                            ...
                            <select name="city_id" id="city_id" class=" form-control city_id states">
                  ...
                  <div class="card-footer">
                    ...
                    <a href="<?php echo e(route('institute-list')); ?>" class="btn btn-secondary">Cancel</a>
                  </div>
                </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
                        ...
                        $('#submitForm')[0].reset();
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('institute-list')); ?>";
                            }, 3000);
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/merarum/public_html/app/resources/views/admin/institute/institute-edit.blade.php ENDPATH**/ ?>